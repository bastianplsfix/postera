			...
			<BaseDialog.Portal>
				...
				<BaseDialog.Popup className="fixed bottom-0 left-0 right-0 w-full rounded-t-lg bg-gray-50 p-6 text-gray-900 outline outline-1 outline-gray-200 transition-all duration-150 data-[ending-style]:translate-y-4 data-[ending-style]:opacity-0 data-[starting-style]:translate-y-4 data-[starting-style]:opacity-0 dark:outline-gray-300">
					...
					<BaseDialog.Description className="mb-6 text-base text-gray-600">
						...
						laoreet erat orci nec dolor. Quisque ac dictum enim. Vivamus luctus,
						magna et commodo posuere, tortor risus facilisis lectus, a porttitor
						nisi lacus eget elit. Pellentesque habitant morbi tristique senectus
						et netus et malesuada fames ac turpis egestas. Maecenas vel ipsum at
						velit tincidunt facilisis. Etiam eget orci quis nisi dictum gravida.
						Suspendisse potenti.
